...
printf "\e[48;5;11Список пиров в файле конфигурации %s:\n%s\n" "$wg_conf_path" "$peers\e[0m"

# Запрашиваем у пользователя номер пира
printf "\e[48;5;11Введите номер пира, для которого нужно вывести информацию: \e[0m"
read peer_number
...
if [ -f $peer_conf_path ]; then
    ...
    printf "\e[48;5;12Чтобы подключиться по файлу, создайте файл \e[48;5;81peer.conf\e[48;5;12 со следующим содержимым и импортируйте его в WireGuard \e[0m \n"
