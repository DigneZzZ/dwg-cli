...
printf "\e[48;5;11mСписок пиров в файле конфигурации %s:\n%s\n" "$wg_conf_path" "$peers\e[0m"

# Запрашиваем у пользователя номер пира
printf "\e[48;5;11mВведите номер пира, для которого нужно вывести информацию: \e[0m"
read peer_number
...
if [ -f $peer_conf_path ]; then
    ...
    printf "\e[48;5;12mЧтобы подключиться по файлу, создайте файл \e[48;5;81mpeer.conf\e[48;5;12m со следующим содержимым и импортируйте его в WireGuard \e[0m \n"
